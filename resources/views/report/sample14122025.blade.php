@php
    ...
    $containerIDs = @App\Models\ProtocolSkuPack::where('ProtocolID', $sampleReport->sample->protocol->ProtocolID)
        ->pluck('ContainerID')
        ->toArray();
    $containers = @App\Models\Container::whereIn('ContainerID', array_unique($containerIDs))->with('packaging')->get();
    $containersCount = 0;
        ...
        <div class="row">
            <div class="col-md-12">
                <button onclick="window.print()" class="no-print print-button"
                    style="background-color: #74992e; color: white; padding: 6px 12px; border: none; cursor: pointer;">
                    Print
                </button>
                ...
                <center>
                    <table border="0" width="1000px" cellspacing="1" cellpadding="3" class="white">
                        <tbody>
                            <tr>
                                <th>
                                    <center style="position: fixed; top: 30px; left:30px; z-index:9999;background:#fff">
                                        <table style="width: 100%; border: 1px solid #000; border-collapse: collapse;">
                                            <tr>
                                                ...
                                                <th
                                                    style="width: 46%; border-right: 1px solid #000; border-bottom: 1px solid #000; text-align: center; font-size: 15px; padding: ;">
                                                    ACI HealthCare Limited
                                                </th>
                                                <th
                                                    style="width: 45%; border-bottom: 1px solid #000; text-align: center; font-size: 15px; padding: ;">
                                                    {{-- Page 1 of 3 <br> --}}
                                                    <p>Report No:
                                            ...
                                            <tr>
                                                <th
                                                    style="border-right: 1px solid #000; border-left: 1px solid #000; font-size: 15px; padding: ; text-align: center;">
                                                    {{ $sampleReport->Headline ?? $sampleReport->sample->protocol->product->ProductName }}
                                                </th>

                                                <th style="text-align: center; font-size: 15px; padding: ;">
                                                    Quality Control
                                                </th>
                                            </tr>
                                        </table>
                                        <table border="1" width="1000px" cellspacing="1" cellpadding="3"
                                            class="white" style="margin-top:1%;">
                                            <tr>
                                        ...
                                        <table border="1" width="1000px" cellspacing="1" cellpadding="3"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="5" style="width:40%">
                                                    ACI HealthCare Limited, Sonargaon Museum Gate-1 Road, Treepordi,
                                                    Sonargaon, Narayanganj, 1440, Bangladesh (BGD)
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <tr>
                                                        @if ($loop->first && $loop->parent->first)
                                                            <th align="left" style="width:20%"
                                                                rowspan="{{ $containersCount }}">Description of the
                                                                Primary Packaging Material</th>
                                                        @endif
                                                        <td align="left" colspan="5">
                                                            <p><strong>{{ $packagingProfile->PackagingName }}</strong>
                                                            </p>
                                                            <p style="text-align:left;">Source:
                                                                {{ $packagingProfile->PackagingSource ?? 'N/A' }}
                                                            </p>
                                                            <p style="text-align:left;">DMF:
                                                                {{ $packagingProfile->PackagingDMF ?? 'N/A' }}</p>
                                                            <p style="text-align:left;">Resin:
                                                                {{ $packagingProfile->PackagingResin ?? 'N/A' }}</p>
                                                            <p style="text-align:left;">Colorant:
                                                                {{ $packagingProfile->PackagingColorant ?? 'N/A' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                ...
                                                @forelse ($sampleReport->sampleReportDetails as $detail)
                                                    ...
                                                    @php
                                                        ...
                                                        if ($detail->SubTestID) {
                                                            ...
                                                            $data = Test::where('TestID', $detail->TestID)->first()[
                                                                'TestName'
                                                            ];
                                                        }
                                ...
                                <th>
                                    ...
                                    <center style="text-align: center;" class="page-break">
                                        ...
                                        <ol
                                            ...
                                            <li>{{ $note[0] ?? 'Detection limit for Atorvastatin RC D = 0.008232% and for Atorvastatin RC H = 0.031200%.' }}
                                            </li>
                                            <li>{{ $note[1] ?? 'Quantitation limit for Atorvastatin RC D = 0.012348% and for Atorvastatin RC H = 0.050200%.' }}
                                            </li>
                                            <li>{{ $note[2] ?? '*Atorvastatin related compound D undergoes transformation equilibrium to the atorvastatin epoxy THF analog. These two impurities are to be reported against combined specification i.e. (1.0% + 0.5% = 1.5%) under atorvastatin related compound D.' }}
                                            </li>
                                            <li>{{ $note[3] ?? '** Microbial enumeration test and tests for special microorganism to be performed initially and yearly at 25±2 °C / 60±5 % RH condition.' }}
                                            </li>
                                            <li>{{ $note[4] ?? 'BRL = Below Reporting Level. The reporting level for impurities is 0.1%.' }}.
                                            </li>
                                        ...
                                        <!--Signature -->
                                        <div style=" border:0px solid #000; margin-bottom:50px;">
                                            <table border="1" width="1000px" cellspacing="1" cellpadding="3"
                                                class="white">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            {{ $sampleReport->CreatedAt ? \Carbon\Carbon::parse($sampleReport->CreatedAt)->timezone('Asia/Dhaka')->format('Y-m-d') : '' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            {{ $reviewByOneComment ? \Carbon\Carbon::parse($reviewByOneComment->CreateDate)->format('Y-m-d') : '' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align: center;">
                                                        ...
                                                        <td style="text-align: center;">
                                                            {{ $reviewByTwoComment ? \Carbon\Carbon::parse($reviewByTwoComment->CreateDate)->format('Y-m-d') : '' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            {{ $approvalByComment ? \Carbon\Carbon::parse($approvalByComment->CreateDate)->format('Y-m-d') : '' }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
