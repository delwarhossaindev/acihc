...
<head>
    ...
    <style type="text/css">
        @page {
            size: A4;
            margin: 20mm 60px; /* Reduce bottom margin for footer space */
        }
                ...
                <center>
                    <table border="0" width="1000px" cellspacing="1" cellpadding="3" class="white">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th style="page-break-before: always; text-align: center;">
                                    <center>
                                        <table style="width: 100%; border: 1px solid #000; border-collapse: collapse;">
                                            <tr>
                                        ...
                                        <table border="1" width="1000px" cellspacing="1" cellpadding="3"
                                            ...
                                            <tr>
                                                <th align="left"> Product Name:</th>
                                                <td align="left" colspan="3">
                                                    {{ $sampleReport->sample->protocol->product->ProductName }}</td>
                                            </tr>
                                            <tr>
                                                <th align="left"> Batch No:</th>
                                                <td align="left">
                            ...
                            <tr>
                                <th style="page-break-before: always; text-align: center;">
                                    <center>
                                        ...
                                        <!--Signature -->
                                        <div
                                            style="float:left; width:99%; border:0px solid #000; margin-top:40px; margin-bottom:50px;">
                                            <table border="1" width="1000px" cellspacing="1" cellpadding="3"
                                                class="white">
                                                <thead>
                                                    <tr>
