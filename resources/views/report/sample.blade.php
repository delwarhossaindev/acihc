        ...
        <div class="row">
            <div class="col-md-12">
                <div class="no-print" style="position: absolute; top: 20px; right: 20px; z-index: 9999; display: flex; gap: 8px;">
                    ...
                    <a href="{{ route('sample.report.pdf', $sampleReport->SampleReportID) }}" target="_blank" rel="noopener"
                    ...
                    <a href="{{ route('sample.report.pdf', $sampleReport->SampleReportID) }}?download=1"
                                        ...
                                        <table style="width: 100%; border: 1px solid #000; border-collapse: collapse;">
                                            ...
                                            <tr>
                                                <th
                                                    ...
                                                    {{ $sampleReport->Headline ?? $sampleReport->sample->product->ProductName }}
                                                </th>
                        ...
                        <tbody>
                                        ...
                                        <table border="1" width="1000px" cellspacing="1" cellpadding="3"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="3">
                                                    ...
                                                    {{ $sampleReport->sample->product->ProductName ?? '' }}
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <tr>
                                <th>
                                    <center style="">
                                        <table border="1" width="1000px" cellspacing="1" cellpadding="3"
                                            class="white" style="margin-top:0.5%;">
                                            <tr>
                                                ...
                                                @foreach ($container->packaging as $key => $packagingProfile)
                                                    <tr>
                                                        ...
                                                        <td align="left" colspan="5">
                                                            <p style="text-align:left; margin-top:0px;"><strong>{{ $packagingProfile->PackagingName }}</strong>
                                                            </p>
                                                            <p style="text-align:left; margin-top:-6px;">Source:
                                                                {{ $packagingProfile->PackagingSource ?? 'N/A' }}
                                                            </p>
                                                            <p style="text-align:left; margin-top:-6px;">DMF:
                                                                {{ $packagingProfile->PackagingDMF ?? 'N/A' }}</p>
                                                            <p style="text-align:left; margin-top:-6px;">Resin:
                                                                {{ $packagingProfile->PackagingResin ?? 'N/A' }}</p>
                                                            <p style="text-align:left; margin-top:-6px; margin-bottom:0px;">Colorant:
                                            ...
                                            <tbody>
                                                ...
                                                @forelse ($sampleReport->sampleReportDetails as $detail)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:left;">{{ $detail->Specification }}</td>
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    @endphp
                                    <center style="text-align: center;" class="">
