<form action="{{ route('pack.update', $pack->PackID) }}" method="post" class="needs-validation" novalidate>
    @csrf
    @method('patch')
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <span class="modal-icon-badge"><i class="fa fa-cube"></i></span>
                        Update Unit Pack
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    @include('system.pack.modal.__input')
                </div>
