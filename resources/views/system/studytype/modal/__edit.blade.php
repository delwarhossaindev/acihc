<form action="{{ route('studytype.update', $studytype->StudyTypeID) }}" method="post" class="needs-validation" novalidate>
    @csrf
    @method('patch')
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <span class="modal-icon-badge"><i class="fa fa-temperature-half"></i></span>
                        Update Study Type
                    </h5>
