<div style="float:left; width:99%; border:0px solid #000;">
    <div style="float:left; width:99%; border-right:0px solid #000;">
        <p style="text-align:left; font-size:16px; font-weight:600">6.
            Manufacturing Site Address:</p>
        <p style="text-align:left; font-size:14px;; font-weight:400; margin-bottom: 1px; margin-top: 1px;">
        ...
        <p style="text-align:left; font-size:14px;; font-weight:400;  margin-top: 1px;">
