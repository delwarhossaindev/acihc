...
<div style="float:left; width:99%; border:1px solid #000;">
    <div style="float:left; width:60px; border-right:1px solid  #000;">
        <div style="float:left; width:99%; text-align:left; padding:15px; border:0px solid  red;">
    ...
    <div style="float:left; width:99%; border-right:0px solid #000;">
        <div
            ...
            <span style="font-weight:400">
                @forelse ($protocol->product->skus as $key => $strength)
                    {{ $strength->ProductStrength }} {{ !$loop->last ? ',' : '' }}
                @empty
                @endforelse
            </span>
        </div>
