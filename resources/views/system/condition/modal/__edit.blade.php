<form action="{{ route('condition.update', $condition->ConditionID) }}" method="post" class="needs-validation" novalidate>
    @csrf
    @method('patch')
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <span class="modal-icon-badge"><i class="fa fa-cloud-sun"></i></span>
                        Update Condition
                    </h5>
