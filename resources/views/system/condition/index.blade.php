...
@section('content')
    ...
    <div class="row align-items-center mb-4 g-3">
        <div class="col-md-8">
            <div class="d-flex align-items-center">
                <span class="settings-icon-badge me-3"><i class="fa fa-cloud-sun"></i></span>
                <div>
                    <h4 class="settings-title">Condition</h4>
                    <div class="settings-subtitle">Storage and stability test conditions.</div>
                </div>
            </div>
        </div>
    ...
    <div class="card settings-card">
        <div class="card-header"><i class="fa fa-list me-2 text-primary"></i> Condition List</div>
        <div class="card-body">
