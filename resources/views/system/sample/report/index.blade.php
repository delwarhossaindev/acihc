...
@section('content')
    <div class="row mt-3">
        ...
        <div class="col-md-2"><input type="text" id="product" class="form-control" placeholder="Search Product"></div>
        <div class="col-md-2"><input type="text" id="batch" class="form-control" placeholder="Search Batch"></div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="mt-3">
                    <form action="{{ route('sample.approval.store', 4) }}" method="post" class="needs-validation"
                        novalidate>
                        @csrf
                        @method('post')
                        <input type="hidden" name="sample_report_id" id="sample_id">
